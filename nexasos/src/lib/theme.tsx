...
const translations: Record<Lang, Record<string, string>> = {
  th: {
    ...
    'nav.skills':     'Skill Wallet',
    'nav.feasibility':'Feasibility (L6)',
    'nav.ingest':     'นำเข้าข้อมูล',
    'nav.taxonomy':   'Data Model',
    'nav.audit':      'Audit Trail',
    'nav.staff':      'My Workspace',
    'nav.mydata':     'ข้อมูลของฉัน',
    'nav.myai':       'AI ส่วนตัว',
    'nav.deptai':     'AI แผนก',
    'nav.onboarding': 'ตั้งค่าระบบ',
    'nav.memory':     'ค้นหา Memory',
    'nav.readiness':  'สุขภาพองค์กร',
    // Nav sections
    'nav.section.daily':  'งานประจำวัน',
    'nav.section.dept':   'งานแผนก',
    'nav.section.tools':  'เครื่องมือ AI',
  ...
  en: {
    ...
    'nav.memory':     'Memory Search',
    'nav.readiness':  'Org Health',
    'nav.section.daily':  'DAILY',
    'nav.section.dept':   'DEPARTMENT',
    'nav.section.tools':  'AI TOOLS',
